...
namespace ChallengeCup.Middleware
{
    public class TokenProviderMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            // 只接受post请求。Request must be POST with Content-Type: application/x-www-form-urlencoded
        ...
        private async Task ReturnBadRequest(HttpContext context)
        {
            ...
            await context.Response.WriteAsync(JsonConvert.SerializeObject(ResultUtil.Fail("认证失败")));
        }
